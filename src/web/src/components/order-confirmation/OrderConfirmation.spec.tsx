...
describe('OrderConfirmation', () => {
  ...
  it('should render the order confirmation form', () => {
    ...
    expect(
      screen.getByText('Your order has been placed successfully. We will contact you soon.'),
    ).toBeInTheDocument()
    expect(
      screen.getByText('You will be able to buy more corn after a minute.'),
    ).toBeInTheDocument()
    expect(screen.getByText('1 🌽')).toBeInTheDocument()
    expect(screen.getByRole('button', { name: /Buy more corn/i })).toBeInTheDocument()
  })
